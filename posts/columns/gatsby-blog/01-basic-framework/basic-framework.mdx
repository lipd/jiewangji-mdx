...
部署成功后，我们会看到博客的地址（上图 url 中的内容），我们现在就可以使用任何一台设备的浏览器去访问我们的项目了。我个人觉得通过 Serverless Framework 来部署网站，其便利程度不亚于使用 Gatsby 官方推荐的 Netlify。
...
如果你最后没有跟上的话进度的话，可以切换到 step0 分支，将你的代码与我保持同步：
